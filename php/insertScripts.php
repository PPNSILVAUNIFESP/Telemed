<?php
    ...
    if ($tabela == 'tbmedicos'){
        ...
        echo '<script>alert("'.$msg.'");window.location.href="../Cmedico.php";</script>';            
    } 
    ...
    if ($tabela == 'tbpacientes'){
        ...
        echo '<script>alert("'.$msg.'");window.location.href="../Cpaciente.php";</script>';            
    }
    ...
    if ($tabela == 'tbconsultas'){
        ...
        echo '<script>alert("'.$msg.'");window.location.href="../Cconsulta.php";</script>';            
    } 
