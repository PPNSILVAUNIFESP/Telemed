...
function configurarRedirecionamento(idElemento, urlBase) {
  $(idElemento).change(function () {
      window.location.href = `././${urlBase}.php?id=${$(this).val()}`;
  });
}

var tbPacientes = inicializarTabela('#tbPacientes');
var tbMedicos = inicializarTabela('#tbMedicos');
var tbHistorico = inicializarTabela('#tbHistorico');
...
configurarRedirecionamento('#historicoMedico', 'Hmedico');
configurarRedirecionamento('#historicoPaciente', 'Hpaciente');
